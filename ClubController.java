...
public class ClubController {
	...
	public String loginStudent(@RequestParam String studentId,
	    ...
	    boolean success = clubService.validateClub(studentId, studentPassword);

	    if (success) {
	        return "dashboard"; // redirect to event dashboard
	    } else {
	        ((RedirectAttributes) model).addAttribute("error", "Invalid login");
	        return "login";
	    }
	}
}